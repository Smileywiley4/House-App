  ...
  return (
    <div className={`relative ${className} overflow-hidden`}>
      ...
      <a
        ...
        className="absolute bottom-3 right-3 z-[500] inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/95 text-xs font-semibold text-[#14192E] shadow-md hover:bg-white transition-colors"
      >
        Google Maps
