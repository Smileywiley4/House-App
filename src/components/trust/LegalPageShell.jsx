    ...
    <div className="min-h-screen bg-[#fafaf8]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 md:py-14">
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-[#10b981] mb-8 transition-colors"
        >
          <ChevronLeft size={16} />
          Back to home
        </Link>
        <header className="mb-10 border-b border-slate-200 pb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-[#1a2234] mb-3">{title}</h1>
        ...
        <article className="prose prose-slate max-w-none prose-headings:text-[#1a2234] prose-a:text-[#10b981] prose-a:no-underline hover:prose-a:underline">
          {children}
        </article>
      </div>
    </div>
