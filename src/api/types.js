...
/** @typedef {{ id: string, email?: string, full_name?: string, default_weights?: Record<string, number>, role?: string, plan?: string, realtor_license?: string, license_number?: string, brokerage?: string, brokerage_name?: string, state?: string, license_state?: string, license_verification_status?: 'self_reported'|'pending'|'verified'|'rejected', license_verified_at?: string|null, linked_realtor_id?: string|null, avatar_url?: string }} User */
